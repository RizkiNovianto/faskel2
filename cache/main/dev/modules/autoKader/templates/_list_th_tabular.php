...
?>
  ...
  <th id="sf_admin_list_th_valid">
          <?php if ($sf_user->getAttribute('sort', null, 'sf_admin/kader/sort') == 'valid'): ?>
      <?php echo link_to(__('Valid'), 'kader/list?sort=valid&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/kader/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'sf_admin/kader/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('Valid'), 'kader/list?sort=valid&type=asc') ?>
      <?php endif; ?>
          </th>
