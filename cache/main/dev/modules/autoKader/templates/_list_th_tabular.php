...
?>
  ...
  <th id="sf_admin_list_th_valid_view">
        <?php echo __('Valid') ?>
          </th>
  ...
  <th id="sf_admin_list_th_keterangan">
          <?php if ($sf_user->getAttribute('sort', null, 'sf_admin/kader/sort') == 'keterangan'): ?>
      <?php echo link_to(__('Keterangan'), 'kader/list?sort=keterangan&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/kader/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'sf_admin/kader/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('Keterangan'), 'kader/list?sort=keterangan&type=asc') ?>
      <?php endif; ?>
          </th>
