...
class autoKaderActions extends sfActions
{
  ...
  protected function updateKaderFromRequest()
  {
    ...
    if (isset($kader['valid']))
    {
      $this->kader->setValid($kader['valid']);
    }
    if (isset($kader['status']))
    {
      $this->kader->setStatus($kader['status']);
    }
    if (isset($kader['keterangan']))
    {
      $this->kader->setKeterangan($kader['keterangan']);
    }
  }
