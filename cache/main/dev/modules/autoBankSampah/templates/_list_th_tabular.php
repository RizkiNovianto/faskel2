...
?>
  ...
  <th id="sf_admin_list_th_keterangan">
          <?php if ($sf_user->getAttribute('sort', null, 'sf_admin/bank_sampah/sort') == 'keterangan'): ?>
      <?php echo link_to(__('Keterangan'), 'bankSampah/list?sort=keterangan&type='.($sf_user->getAttribute('type', 'asc', 'sf_admin/bank_sampah/sort') == 'asc' ? 'desc' : 'asc')) ?>
      (<?php echo __($sf_user->getAttribute('type', 'asc', 'sf_admin/bank_sampah/sort')) ?>)
      <?php else: ?>
      <?php echo link_to(__('Keterangan'), 'bankSampah/list?sort=keterangan&type=asc') ?>
      <?php endif; ?>
          </th>
