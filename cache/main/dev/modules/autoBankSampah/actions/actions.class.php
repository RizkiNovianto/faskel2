...
class autoBankSampahActions extends sfActions
{
  ...
  protected function updateBankSampahFromRequest()
  {
    ...
    if (isset($bank_sampah['status']))
    {
      $this->bank_sampah->setStatus($bank_sampah['status']);
    }
    if (isset($bank_sampah['keterangan']))
    {
      $this->bank_sampah->setKeterangan($bank_sampah['keterangan']);
    }
  }
  ...
  protected function getLabels()
  {
    return array(
      ...
      'bank_sampah{status}' => 'Status:',
      'bank_sampah{keterangan}' => 'Keterangan:',
    );
  }
}
