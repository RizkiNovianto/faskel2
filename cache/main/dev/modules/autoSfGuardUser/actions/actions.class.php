...
class autoSfGuardUserActions extends sfActions
{
  ...
  protected function processFilters()
  {
    if ($this->getRequest()->hasParameter('filter'))
    {
      ...
      $this->getUser()->getAttributeHolder()->removeNamespace('sf_admin/sf_guard_user');
  ...
  protected function addFiltersCriteria($c)
  {
    ...
    {
      $criterion = $c->getNewCriterion(sfGuardUserPeer::GROUPS, '');
      $criterion->addOr($c->getNewCriterion(sfGuardUserPeer::GROUPS, null, Criteria::ISNULL));
      $c->add($criterion);
    }
    else if (isset($this->filters['groups']) && $this->filters['groups'] !== '')
    {
      $c->add(sfGuardUserPeer::GROUPS, $this->filters['groups']);
    }
  }
  ...
  protected function getLabels()
  {
    return array(
      ...
      'sf_guard_user{password_bis}' => 'Password (Ulang):',
      'sf_guard_user{last_login}' => 'Login Terakhir:',
      'sf_guard_user{is_active}' => 'Status Aktif:',
