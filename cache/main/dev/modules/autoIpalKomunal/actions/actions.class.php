...
class autoIpalKomunalActions extends sfActions
{
  ...
  protected function updateIpalKomunalFromRequest()
  {
    ...
    if (isset($ipal_komunal['status']))
    {
      $this->ipal_komunal->setStatus($ipal_komunal['status']);
    }
    if (isset($ipal_komunal['keterangan']))
    {
      $this->ipal_komunal->setKeterangan($ipal_komunal['keterangan']);
    }
  }
  ...
  protected function getLabels()
  {
    return array(
      ...
      'ipal_komunal{status}' => 'Status:',
      'ipal_komunal{keterangan}' => 'Keterangan:',
    );
  }
}
