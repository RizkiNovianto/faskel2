...
<div class="form-row">
  <?php echo label_for('ipal_komunal[status]', __($labels['ipal_komunal{status}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('ipal_komunal{status}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('ipal_komunal{status}')): ?>
    <?php echo form_error('ipal_komunal{status}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = get_partial('status', array('type' => 'edit', 'ipal_komunal' => $ipal_komunal)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

<div class="form-row">
  <?php echo label_for('ipal_komunal[keterangan]', __($labels['ipal_komunal{keterangan}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('ipal_komunal{keterangan}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('ipal_komunal{keterangan}')): ?>
    <?php echo form_error('ipal_komunal{keterangan}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_textarea_tag($ipal_komunal, 'getKeterangan', array (
  'size' => '30x3',
  'control_name' => 'ipal_komunal[keterangan]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>
